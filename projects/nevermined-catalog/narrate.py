...
timing = {
    ...
    "line_durs": [round(d, 2) for d in dur],          # avatar bubble lengths = line_durs[0] (intro) / [4] (cta)
...
json.dump(timing, open("timing.json", "w"), indent=2)   # scripts/retime.py applies this to index.html
